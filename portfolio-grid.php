                ...
                <div class="col-lg-<?php echo esc_attr( $settings['portfolio_column'] ) ?> col-md-6 col-12 grid">
                    ...
                    <div class="grid__item">
                        ...
                        <div class="portfolio-grid-wrapper">
                                ...
                                <div class="portfolio-title portfolio-title-custom">
                                        ...
                                        <?php
                                         ...
                                         echo '<a href="' . esc_url( get_permalink() ) . '"><div class="portfolio-overlay"></div></a>';
                                ...
                                <div class="portfolio-details">
                                    ...
                                    <div class="portfolio-title">
                                        ...
                                        <div class="tracem-ovh">
                                            ...
                                            <?php echo '<a href="' . esc_url( get_permalink() ) . '"><p>'.  get_the_excerpt( ) .'</p></a>'; ?>
